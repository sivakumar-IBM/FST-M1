...
public class Activity2 {
    ...
    public void getUserInfo() {
        ...
        Response response =
                given().contentType(ContentType.JSON) // Set headers
                        .pathParam("username", "siva1989") // Pass request body from file
        ...
        response.then().body("username", equalTo("siva1989"));
    ...
    public void deleteUser() throws IOException {
        Response response =
                given().contentType(ContentType.JSON) // Set headers
                        .pathParam("username", "siva1989") // Add path parameter
                        .when().delete(ROOT_URI + "/{username}"); // Send POST request

        // Assertion
        System.out.println(response.getBody().asString());
        response.then().body("code", equalTo(200));
        response.then().body("message", equalTo("siva1989"));
    }
}